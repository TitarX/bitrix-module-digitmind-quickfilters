...
$MESS['DIGITMIND_QUICKFILTERS_FIELDS_DESCRIPTION'] = "<div style=\"margin: 20px 0; padding: 10px; border: 1px solid #ccc; background: #f9f9f9;\">
    ...
    <ul style=\"margin-top: 10px;\">
        <li>Свойство <b>PAGE_URL</b> (строка, обязательно) — URL страницы вывода. URL страницы сайта, на которой будет выведен контент.</li>
        <li>Свойство <b>CONTENT_URL</b> (строка, обязательно) — URL страницы источника контента. URL страницы сайта, содержимое которой нужно вывести по запросу URL вывода.</li>
